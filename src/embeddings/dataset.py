"""
Embedding Dataset, taken from SubgraphRAG

https://github.com/Graph-COM/SubgraphRAG/blob/main/retrieve/src/dataset/emb.py
...
class EmbInferDataset:
    def __init__(
        ...
        """
        self.processed_dict_list = self._process(raw_set, entity_identifiers, save_path)
        ...
        print(
            f"# raw samples: {len(raw_set)} | # processed samples: {len(self.processed_dict_list)}"
        )

    def _process(self, raw_set, entity_identifiers, save_path):
